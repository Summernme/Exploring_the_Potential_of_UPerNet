...
async def train(segmentation_module, iterator, optimizers, history, epoch, args, noti_bot):
    ...
    for i in range(args.epoch_iters):
        ...
        if i % args.disp_iter == 0:
            ...
            print_msg = 'Epoch: [{}][{}/{}], Time: {:.2f}, Data: {:.2f}, LR: encoder {:.6f}, decoder {:.6f}, {}, {}' \
...
def create_multi_source_train_data_loader(args):
    ...
    while True:  # TODO(LYC):: set random seed.
        source_idx = np.random.choice(
            len(training_records), 1, p=sample_prob)[0]
...
async def main(args):
    ...
    for epoch in range(args.start_epoch, args.num_epoch + 1):
        await train(segmentation_module, iterator_train,
            optimizers, history, epoch, args, noti_bot)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--id', default='c-attention',
    ...
    # Test arguments
    parser.add_argument('--test_img', default="ADE_val_00000001.jpg")
    parser.add_argument('--test_gpu', default=1, type=int)
